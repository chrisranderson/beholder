...
Polymer({
  ...
  _onDataChange: function() {
    ...
    this._currentDataValid = true;  // Set flag to indicate data is now valid.
    this._updateDataExtent();  // Calculate new data extent.
    if (this._isReady) {
      this._renderData();
    }
  },
  ...
  _findTileSideLength: function() {
    if (this._currentDataValid) {
      ...
      if (this._debug == true) {
        console.log("WARNING: vz-heatmap-ts is reverting to zero height as passed data is invalid.")
      }
